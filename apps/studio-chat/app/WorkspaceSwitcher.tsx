...
export function WorkspaceSwitcher({
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 text-[11px] font-mono px-2.5 py-1.5 rounded-md bg-deep border border-edge-soft hover:text-ink hover:border-edge hover:bg-elevated transition-all cursor-pointer"
